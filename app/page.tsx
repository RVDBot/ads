      ...
      <main className="max-w-[1200px] mx-auto px-6 py-6">
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Chart placeholders — will be replaced in Task 7 */}
            <div className="grid grid-cols-[2fr_1fr] gap-3 mb-5">
              <div className="bg-surface-1 border border-border-subtle rounded-2xl p-4 h-48 flex items-center justify-center">
                <span className="text-text-tertiary text-[13px]">ROAS Trend</span>
              </div>
              <div className="bg-surface-1 border border-border-subtle rounded-2xl p-4 h-48 flex items-center justify-center">
                <span className="text-text-tertiary text-[13px]">Spend per Land</span>
              </div>
            </div>
          </>
        )}
