...
- **campaign_targeting**: { "campaign_name": "exacte naam", "country": "nl", "languages": ["nl"] } — stelt geo-targeting en taal in; country = nl/de/fr/es/it/be/at/ch/com/gb/us/etc; languages is optioneel en overschrijft de standaard talen (nl/de/fr/es/it/en)
